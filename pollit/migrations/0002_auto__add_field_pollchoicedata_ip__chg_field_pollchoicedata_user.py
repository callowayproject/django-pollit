...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PollChoiceData.ip'
        db.add_column('pollit_pollchoicedata', 'ip', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PollChoiceData.ip'
        db.delete_column('pollit_pollchoicedata', 'ip')
